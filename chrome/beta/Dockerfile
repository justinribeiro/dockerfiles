...
#
# Changes are to run on my 15.04 + GTX 970 setup; your mileage will vary (fair warning)
#
#        docker run -d \
#                --memory 4gb
#                --net host
...
#                justinribeiro/chrome:beta --user-data-dir=/data --force-device-scale-factor=1
